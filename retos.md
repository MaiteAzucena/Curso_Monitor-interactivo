...
A continuación:
- Coloca la captura en la **parte superior de la pantalla**.
- Debajo de la imagen, escribe **al menos dos funciones** a las que se puede acceder desde este menú principal.
...
2. Utiliza el sistema de **proyección inalámbrica (EsharePRO)** para proyectar la pantalla desde:
   ...
   - un ordenador.
3. Configura el **modo Moderador**, de forma que sea necesaria la autorización previa del moderador para proyectar o compartir archivos.
...
2. Utiliza la función **Lápiz (capa de anotación)** para destacar un contenido interesante de la web.
3. Cambia el PDF al **modo miniatura** y desplázalo al **extremo superior derecho** de la pantalla.
