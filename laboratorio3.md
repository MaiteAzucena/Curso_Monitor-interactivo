# Laboratorio 3: Mirroring – Proyección inalámbrica en el monitor interactivo
...
🛠️ **Supuesto práctico. Ejemplo real de aula:**
> El docente accede desde su ordenador al *Campus Virtual de Defensa* para explicar a su alumnado el contenido de uno de sus cursos.
**Desarrollo del ejemplo**:
- Abrir el navegador web en el PC y acceder al Campus Virtual.
- Iniciar sesión con las credenciales del docente.
- Acceder a uno de los cursos disponibles.
- Navegar hasta un cuestionario del curso y mostrar su estructura (intentos, tiempo, tipo de preguntas).
- Acceder a una tarea creada en el curso y explicar:
-- enunciado,
-- fecha de entrega,
-- tipo de entrega.
...
2. Activar la opción de proyección inalámbrica:
